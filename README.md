...
> Py clean and normalize csv data

[![PyPI version](https://badge.fury.io/py/py-csv-clean.svg)](https://pypi.org/project/py-csv-clean/)
...
from py_csv_clean import batch
